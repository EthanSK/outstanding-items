...
spec = importlib.util.spec_from_file_location('state', Path(__file__).resolve().parents[1] / 'plugins/outstanding-items/skills/outstanding-items/scripts/skill-update-state.py')
