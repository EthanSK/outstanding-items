...
def check_item_provenance() -> list[str]:
    ...
    for text, phrase, name in (
        ...
        (skill, "Do not invent filler", "SKILL.md"),
        ...
        (read(DOCS / "index.html"), "Any real loose end you still need to look at is added as Agent", "docs/index.html"),
        (read(ROOT / "AGENTS.md"), "Before saying there are no outstanding items", "AGENTS.md"),
        (read(ROOT / "CLAUDE.md"), "Before saying there are no outstanding items", "CLAUDE.md"),
        (read(ROOT / "examples" / "global-rules" / "codex-agents-md.md"), "Before saying there are no outstanding", "codex-agents-md.md"),
        (read(ROOT / "examples" / "global-rules" / "claude-code-claude-md.md"), "Before saying there are no outstanding", "claude-code-claude-md.md"),
        (read(ROOT / "examples" / "global-rules" / "project-instructions.md"), "Before saying there", "project-instructions.md"),
    ):
