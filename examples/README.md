...
| [`outstanding-items.json`](outstanding-items.json) | The synthetic schema-v7 canonical ledger used by the Full outstanding items UI, including immutable provenance, its discussion trigger, durable ordering intent, and optional tooltip explanations. |
