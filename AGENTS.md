...
request captured automatically is `Agent`. Each known-origin entry records the
specific discussion point that triggered its capture. Authority ends with that response
